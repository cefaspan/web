...
El sitio está completo y funcional, pero **tres datos son de ejemplo** y hay que reemplazarlos:

| Qué | Dónde | Estado |
|---|---|---|
| Teléfono y WhatsApp | `datos/negocio.json` → `telefono`, `telefonoE164`, `whatsapp` | `0000-0000` de ejemplo |
